...
Meu nome é **Mario Burali** e sou **Desenvolvedor Full Stack**, com foco em **Frontend (React e TypeScript)**, com atuação também em integrações e demandas backend utilizando **Node.js**, **Python/Django**, **REST APIs**, **GraphQL** e **SQL**. Tenho também atuado na infra (CI/CD), criando e melhorando pipelines para Pull Request e Deploy.
